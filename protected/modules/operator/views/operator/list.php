<div class="title-box">
    <h1><span style="float:left;">操作员列表</span><a href="./?r=operator/operator/new" style="float:right;"><span class="add_ico"></span><span>操作员添加</span></a></h1>
    <ul class="sift">
...
<script type="text/javascript">
    ...
    var authEdit = function(id, name) {
        name = encodeURIComponent(name);
        tipsWindown(
            "权限管理", // title：窗口标题
            "iframe:index.php?r=auth/edit&q[id]=" + id + "&q[name]=" + name, // Url：弹窗所加截的页面路径
            "650", // width：窗体宽度
            "450", // height：窗体高度
            "true", // drag：是否可以拖动（ture为是,false为否）
            "", // time：自动关闭等待的时间，为空代表不会自动关闭
